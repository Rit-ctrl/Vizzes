...
def plot_worm(ax,max_overs,team1_rpo,team1_fow,team2_rpo = None,team2_fow=None,color1='#03a9f4',color2='#dd0000',xtick_interval=2): 
    '''
    ...
    rr_team1 = np.cumsum(rr_team1).tolist()
    
    
    if team2_rpo !=None:
        rr_team2 = team2_rpo.copy()
        rr_team2 = np.cumsum(rr_team2).tolist()
    else:
        rr_team2 = None
